...
async def run_migrations() -> None:
    command = Command(
        ...
        location=local_configs.RELATIONAL.VersionFilePath.format(app_name=ConnectionNameEnum.user_center.value),
    )
    await command.init()
...
if __name__ == "__main__":
    ...
    options = {
        ...
        "timeout": 180,
        "logger_class": "burnish_sdk_py.common.loguru.GunicornLogger",
